...
{
    const char* pszTimestamp = "No matter how hard life gets, always stay positive.";
...
public:
    CMainParams() {
        ...
        consensus.BIP16Height = 2; // 87afb798a3ad9378fcd56123c81fb31cfd9a8df4719b9774d71730c16315a092 - October 1, 2012
        ...
        consensus.BIP66Height = 2; // 7aceee012833fa8952f8835d8b1b3ae233cd6ab08fdb27a771d2bd7bdc491894
        consensus.CSVHeight = 2; // 53e0af7626f7f51ce9f3b6cfc36508a5b1d2f6c4a75ac215dc079442692a4c0b
        ...
        genesis = CreateGenesisBlock(1724823305, 7493018, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x46c52383069dfca423d6373fbabe53b30f9032795b98ab0565fbb93fa2d333f5"));
        assert(genesis.hashMerkleRoot == uint256S("0x275018631705ee485bf92cda77606d96fca64cb41cf91aa577115167edcb680a"));
       ...
       base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x88, 0xC2, 0x1E}; 
       base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x88, 0xCE, 0xE4}; 
        ...
        checkpointData = {
            {
                {0, uint256S("46c52383069dfca423d6373fbabe53b30f9032795b98ab0565fbb93fa2d333f5")},
            }
        };
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1724823305, 658978, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xcddef3cbb2ec43a0e75a62a6a5b9d2afe1ac493ae1f66b1349f211ed6a79df01"));
        assert(genesis.hashMerkleRoot == uint256S("0x275018631705ee485bf92cda77606d96fca64cb41cf91aa577115167edcb680a"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        //vSeeds.emplace_back("testnet-seed.orxcointools.com");
        //vSeeds.emplace_back("seed-b.orxcoin.loshan.co.uk");
        ...
        checkpointData = {
            {
                {0, uint256S("cddef3cbb2ec43a0e75a62a6a5b9d2afe1ac493ae1f66b1349f211ed6a79df01")},
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlock(1724823305, 1317345, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x7370d0444c2c6c9ef7b8b7753409282f86e218befc736114a5d2d18713447cdd"));
        assert(genesis.hashMerkleRoot == uint256S("0x275018631705ee485bf92cda77606d96fca64cb41cf91aa577115167edcb680a"));
        ...
        checkpointData = {
            {
                {0, uint256S("7370d0444c2c6c9ef7b8b7753409282f86e218befc736114a5d2d18713447cdd")},
            }
        };
