...
const char * const BITCOIN_CONF_FILENAME = "orxcoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Orxcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/Orxcoin";
#else
    // Unix-like
    return pathRet / ".orxcoin";
#endif
#endif
}
