...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " orxcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  orxcoin-tx [options] <hex-tx> [commands]  Update hex-encoded orxcoin transaction\n" +
            "or:     orxcoin-tx [options] -create [commands]   Create hex-encoded orxcoin transaction\n" +
            "\n";
