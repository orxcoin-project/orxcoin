...
bech32_templates = [
  ...
  ('orx',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('orx',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('orx',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('orx',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('torx',    0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('torx',    0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('torx',    1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('torx',    3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('torx',    0, 20, (False, 'signet',  None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('torx',    0, 32, (False, 'signet',  None, True), Encoding.BECH32,  p2wsh_prefix),
  ('torx',    1, 32, (False, 'signet',  None, True), Encoding.BECH32M, p2tr_prefix),
  ('torx',    3, 32, (False, 'signet',  None, True), Encoding.BECH32M, (OP_3, 32)),
  ('rorx',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('rorx',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('rorx',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('rorx', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
...
bech32_ng_templates = [
  ...
  ('torx',   17, 32, Encoding.BECH32M, False, False, False),
  ('rorx',  3,  1, Encoding.BECH32M, False, False, False),
  ('orx',   15, 41, Encoding.BECH32M, False, False, False),
  ('torx',    0, 16, Encoding.BECH32,  False, False, False),
  ('rorx',  0, 32, Encoding.BECH32,  True,  False, False),
  ('orx',    0, 16, Encoding.BECH32,  True,  False, False),
  ('torx',    0, 32, Encoding.BECH32,  False, True,  False),
  ('rorx',  0, 20, Encoding.BECH32,  False, False, True),
  ('orx',    0, 20, Encoding.BECH32M, False, False, False),
  ('torx',    0, 32, Encoding.BECH32M, False, False, False),
  ('rorx',  0, 20, Encoding.BECH32M, False, False, False),
  ('orx',    1, 32, Encoding.BECH32,  False, False, False),
  ('torx',    2, 16, Encoding.BECH32,  False, False, False),
  ('rorx', 16, 20, Encoding.BECH32,  False, False, False),
]
