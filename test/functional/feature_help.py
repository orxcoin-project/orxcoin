...
"""Verify that starting orxcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start orxcoin with -h for help text")
        ...
        self.log.info("Start orxcoin with -version for version information")
        ...
        self.log.info("Start orxcoind with -fakearg to make sure it does not start")
