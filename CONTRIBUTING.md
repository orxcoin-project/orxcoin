Contributing to Orxcoin Core
============================

The Orxcoin Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the Orxcoin Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/orxcoin-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to orxcoin-qt
...
The following applies to code changes to the Orxcoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Orxcoin
Network Protocol consensus changes.

Whether a pull request is merged into Orxcoin Core rests with the project merge
...
Patches that change Orxcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Orxcoin consensus, it must have been
...
The project leader is the release manager for each Orxcoin Core release.
