# Support for Output Descriptors in Orxcoin Core

Since Orxcoin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `orx1...` for mainnet or `torx1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
existing Orxcoin Core wallets, a convenience function `combo` is
